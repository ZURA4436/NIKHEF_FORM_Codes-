...
l tr2 = g_(2,p4,nu,p2,mu);
l tr3 = g_(3,p4,nu,p1,mu);
l tr4 = g_(4,p3,nu,p2,mu);
l tr5 = g_(5,p3,nu,p2,mu,p4,nu,p1,mu);
l tr6 = g_(6,p4,nu,p2,mu,p3,nu,p1,mu);
.sort
l ans = 1/4*e^4*(1/t^2*tr1*tr2 + 1/u^2*tr3*tr4 - 1/(u*t)*(tr5 + tr6));
.sort
trace4,1;
trace4,2;
trace4,3;
