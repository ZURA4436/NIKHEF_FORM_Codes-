...
l tr1 = g_(1,p3,nu,p5,mu,p2,mu,p5,nu);
l tr2 = g_(1,p3,nu,p6,mu,p2,mu,p6,nu);
l tr3 = g_(3,p3,nu,p5,mu,p2,mu,p6,nu);
l tr4 = g_(1,p3,nu,p6,mu,p2,mu,p5,nu);

l ans = 1/4*e^4*(1/s^2*tr1 + 1/t^2*tr2 + 1/(t*s)*(tr3 + tr4));
.sort
trace4,1;
trace4,2;
trace4,3;
